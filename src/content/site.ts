...
export const siteContent = {
  ...
  description: `${foundedYear}'den bu yana İstanbul merkezli ${brandName}; restoran, kafe, otel ve gıda işletmeleri için konsept geliştirme, kurulum ve işletme danışmanlığı.`,
  seo: {
    keywords: [
      "MD Danışmanlık",
      "Mehmet Doğan",
      ...
      "İstanbul gıda sektörü",
      "fine dining danışmanlığı",
      "catering danışmanlığı",
    ],
    ogImageAlt: `${brandName} — otel, gıda ve içecek sektörü danışmanlığı`,
    streetAddress: "Şair Nedim Caddesi No: 68",
    addressLocality: "Beşiktaş",
    addressRegion: "İstanbul",
    serviceTopics: [
      "Gıda ve içecek danışmanlığı",
      "Restoran konsept geliştirme",
      "Otel F&B danışmanlığı",
      "İşletme kurulumu ve operasyon",
    ],
    services: [
      "Konsept ve marka geliştirme",
      "Mekân ve menü planlaması",
      "İşletme kurulum danışmanlığı",
      "Personel eğitimi",
      "Operasyon ve işletme yönetimi",
      "Sürdürülebilir büyüme danışmanlığı",
    ],
  },
